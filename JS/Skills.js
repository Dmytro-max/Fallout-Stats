...
skills_Ru = {
    Barter: {
        ...
        {
            location: 'Рецепт - Сигнальный холм',
            details: 'Внутри здания — внизу на полке, рядом со входом.',
            level: undefined,
            expected_level: 34,
        },
        {
            location: '«Салида-дель-Соль» южная часть',
            details: 'Здание возле двери ведущей в северную часть. Книга лежит на книжной полке под компьютером.',
            level: undefined,
            expected_level: 28,
        },
        ],
    ...
    E_W: {
        ...
        {
            location: 'Рецепт - Z-38 Центр изучения световых волн',
            details: 'На втором этаже на неработающем терминале.',
            level: undefined,
            expected_level: 32,
        },
        {
            location: '«Сьерра-Мадре» — хранилище Dead Money',
            details: 'Прямо перед входом в хранилище развернитесь и спрыгните на трубы. Книга лежит в сумке с вещами рядом с останками. Чтобы выбраться, идите на восток от сумки, запрыгивайте на трубу с вентилем и возвращайтесь на основную платформу.',
            level: undefined,
            expected_level: 32,
        },
        ]
    ...
    Explosives: {
        ...
        Books: [
            ...
            {
                location: 'Рецепт - X-7A Пробный пуск артиллерии',
                details: 'Внутри командного центра.',
                level: undefined,
                expected_level: 33,
            },
            {
                location: 'Вилла',
                details: 'Лежит под кроватью в комнате, где первый раз встречается Дин Домино. Книга выбивается из-под неё большим количеством взрывчатки, закинутой между стенкой и боковой частью кровати',
                level: undefined,
                expected_level: 33,
            },
        ]
    ...
    Guns: {
        ...
        Books: [
            ...
            {
                location: 'Рецепт - X-7B Зона объектов удара',
                details: 'Внутри прикроватного ящика, лежащего в одной из воронок, может быть обнаружен только после артиллерийского залпа из локации «X-7A Пробный пуск артиллерии».',
                level: undefined,
                expected_level: 34,
            },
            {
                location: '«Сьерра-Мадре» — казино',
                details: 'За ограждением под стойкой кассира. Можно через второй этаж — забирайтесь на опорные балки, оттуда прыгайте вниз в отделение кассира.',
                level: undefined,
                expected_level: 34,
            },
        ],
    ...
    Lockpick: {
        ...
        {
            location: 'Рецепт - X-13 Исследовательский комплекс',
            details: 'При входе в лабораторию дверь прямо и первая слева, левая решётка от центрального мостика.',
            level: undefined,
            expected_level: 32,
        },
        {
            location: '«Сьерра-Мадре» — казино',
            details: 'Служебная часть казино. Самый верхний этаж. Комната с Автодоком. Книга лежит на верху шкафа с инструментами.',
            level: undefined,
            expected_level: 35,
        },
        ]
    ...
    Medicine: {
        ...
        {
            location: 'Рецепт - Посёлок Хиггса',
            details: 'В доме № 103 на книжной полке над письменным столом.',
            level: undefined,
            expected_level: 34,
        },
        {
            location: 'Вилла — клиника',
            details: 'Шкаф в подвале.',
            level: undefined,
            expected_level: 34,
        },
        ]
    ...
    M_W: {
        ...
        {
            location: 'Рецепт - Y-0 Исследовательский центр',
            details: 'На крыше здания.',
            level: undefined,
            expected_level: 33,
        },
        {
            location: 'Вилла — полицейский участок',
            details: 'Подвал. Возле турбины стоящей на проходе пройти в боковую комнатку. На полу перед картотечным шкафом.',
            level: undefined,
            expected_level: 33,
        },
        ]
    ...
    Repair: {
        ...
        {
            location: '«Рецепт - Посёлок Хиггса',
            details: 'В доме #00 на втором этаже, в коридоре на нижнем блоке прибора.',
            level: undefined,
            expected_level: 33,
        },
        ],
    ...
    Science: {
        ...
        {
            location: 'Рецепт - Посёлок Хиггса',
            details: 'В спальне дома № 102, справа от входа на втором этаже.',
            level: undefined,
            expected_level: 33,
        },
        {
            location: 'Люксы',
            details: 'На книжной полке среди старых книг в апартаментах Веры.',
            level: undefined,
            expected_level: 33,
        },
        ]
    ...
    Sneak: {
        ...
        {
            location: '«Пуэста-дель-Соль» — подстанция',
            details: 'В южной части восточной комнаты, на металлическом мостике рядом с большой машиной.',
            level: undefined,
            expected_level: 33,
        },
        ]
    ...
    Speech: {
        ...
        {
            location: 'Рецепт - Посёлок Хиггса',
            details: 'В доме #104 на втором этаже лежит сверху на радио',
            level: undefined,
            expected_level: 33,
        },
        {
            location: '«Тампико»',
            details: 'На полке напротив голопроектора.',
            level: undefined,
            expected_level: 33,
        },
        ]
    ...
    Survival: {
        ...
        {
            location: 'Рецепт - Малая Янцзы',
            details: 'В первой палатке справа от ворот, под двухъярусной кроватью.',
            level: undefined,
            expected_level: 34,
        },
        ]
    ...
    Unarmed: {
        ...
        {
            location: 'Рецепт - Большая Гора — Западный туннель',
            details: 'Сразу справа — за закрытой на простой замок дверью.',
            level: undefined,
            expected_level: 34,
        },
        {
            location: 'Вилла.',
            details: 'У подножия фонтана, возле которого начинается дополнение Dead Money.',
            level: undefined,
            expected_level: 34,
        },
        ]
